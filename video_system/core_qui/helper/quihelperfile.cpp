...
void QUIHelperFile::initDialog(QFileDialog *dialog, const QString &title, const QString &acceptName,
...
QString QUIHelperFile::getDialogResult(QFileDialog *dialog)
{
    QString result;
...
QString QUIHelperFile::getOpenFileName(const QString &filter, const QString &dirName, const QString &fileName,
...
QString QUIHelperFile::getSaveFileName(const QString &filter, const QString &dirName, const QString &fileName,
                                   bool native, int width, int height)
{
    QFileDialog dialog;
...
QString QUIHelperFile::getExistingDirectory(const QString &dirName, bool native, int width, int height)
{
    QFileDialog dialog;
...
QString QUIHelperFile::getFileNameWithExtension(const QString &fileName)
{
    QFileInfo fileInfo(fileName);
    return fileInfo.fileName();
}

QStringList QUIHelperFile::getFolderFileNames(const QStringList &filter)
{
...
bool QUIHelperFile::copyFile(const QString &sourceFile, const QString &targetFile)
{
    bool ok;
...
void QUIHelperFile::deleteDirectory(const QString &path)
{
    QDir dir(path);
    if (!dir.exists()) {
        return;
