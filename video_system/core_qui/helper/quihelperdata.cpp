...
QByteArray QUIHelperData::intToByte(int data)
{
    QByteArray result;
    result.resize(4);
    result[3] = (quint8)(0x000000ff & data);
    result[2] = (quint8)((0x0000ff00 & data) >> 8);
    result[1] = (quint8)((0x00ff0000 & data) >> 16);
    result[0] = (quint8)((0xff000000 & data) >> 24);
    return result;
}
...
QByteArray QUIHelperData::intToByteRec(int data)
{
    QByteArray result;
    result.resize(4);
    result[0] = (quint8)(0x000000ff & data);
    result[1] = (quint8)((0x0000ff00 & data) >> 8);
    result[2] = (quint8)((0x00ff0000 & data) >> 16);
    result[3] = (quint8)((0xff000000 & data) >> 24);
    return result;
}
...
QByteArray QUIHelperData::ushortToByte(ushort data)
{
    QByteArray result;
    result.resize(2);
    result[1] = (quint8)(0x000000ff & data);
    result[0] = (quint8)((0x0000ff00 & data) >> 8);
    return result;
}
...
quint8 QUIHelperData::getOrCode(const QByteArray &data)
{
    int len = data.length();
    quint8 result = 0;
    for (int i = 0; i < len; ++i) {
...
quint8 QUIHelperData::getCheckCode(const QByteArray &data)
{
    int len = data.length();
    quint8 temp = 0;
    for (int i = 0; i < len; ++i) {
...
void QUIHelperData::getFullData(QByteArray &buffer)
{
    //计算校验码
