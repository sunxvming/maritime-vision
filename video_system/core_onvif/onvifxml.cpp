...
QString OnvifXml::getUserToken(const QString &userName, const QString &userPwd)
{
    //要转成UTC格式的时间 "2019-08-10T03:31:37S"  "2020-10-11T09:24:44.988Z"
    //QByteArray Created = QDateTime::currentDateTime().toUTC().toString("yyyy-MM-ddThh:mm:ssS").toLatin1();
    QByteArray Created = QDateTime::currentDateTime().toUTC().toString("yyyy-MM-ddThh:mm:ss.zzzZ").toLatin1();
    //指定字符串进行密码加密
    QByteArray Nonce = Created.toBase64();//"LKqI6G/AikKCQrN0zqZFlg==";
