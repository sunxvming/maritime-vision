...
QString AppConfig::TitleCn = QString::fromUtf8("船舶AI智能监控系统");
QString AppConfig::TitleEn = "Security video management platform";
QString AppConfig::WebServerUrl = "http://127.0.0.1:9001";
QString AppConfig::AIServerUrl = "http://127.0.0.1:9002";
...
bool AppConfig::VisibleIpcSearch = false;
...
int AppConfig::NvrCopyrightName = 0;
int AppConfig::NvrVideoType = 0;
QString AppConfig::NvrUserName = "admin";
QString AppConfig::NvrUserPwd = "admin";
QString AppConfig::NvrVideoIP = "192.168.1.128";
...
QString AppConfig::MapVersionKey = "3.0&ak=u4uVtv69AIuWUFk0Ss2jB0ivFCo5ytpz";
...
QString AppConfig::VideoWidgetUrl = "http://vfx.mtime.cn/Video/2019/02/04/mp4/190204084208765161.mp4";
QString AppConfig::VideoSaveUrl = "rtmp://livetv.dhtv.cn:1935/live/news";
QString AppConfig::VideoPlusUrl1 = "http://vfx.mtime.cn/Video/2019/03/19/mp4/190319212559089721.mp4";
QString AppConfig::VideoPlusUrl2 = "http://vfx.mtime.cn/Video/2019/02/04/mp4/190204084208765161.mp4";
QString AppConfig::VideoPlayUrl1 = "http://vfx.mtime.cn/Video/2019/03/18/mp4/190318231014076505.mp4";
QString AppConfig::VideoPlayUrl2 = "http://vfx.mtime.cn/Video/2019/03/19/mp4/190319212559089721.mp4";
QString AppConfig::VideoPlayUrl3 = "http://vfx.mtime.cn/Video/2019/03/17/mp4/190317150237409904.mp4";
QString AppConfig::VideoPlayUrl4 = "http://vfx.mtime.cn/Video/2019/03/14/mp4/190314223540373995.mp4";
QString AppConfig::VideoAudioUrl = "http://vfx.mtime.cn/Video/2019/03/14/mp4/190314223540373995.mp4";
QString AppConfig::VideoDragUrl = "http://vfx.mtime.cn/Video/2019/03/18/mp4/190318231014076505.mp4";
...
void AppConfig::readConfig()
{
    ...
    WebServerUrl = set.value("WebServerUrl", WebServerUrl).toString();
    AIServerUrl = set.value("AIServerUrl", AIServerUrl).toString();
    ...
    NvrCopyrightName = set.value("NvrCopyrightName", NvrCopyrightName).toInt();
    ...
    NvrVideoIP = set.value("NvrVideoIP", NvrVideoIP).toString();
    set.endGroup();
...
void AppConfig::checkConfig()
{
    ...
    if (!QUIHelper::checkIniFile(ConfigFile)) {
        //首次启动将窗体位置移到中间
        QRect deskRect = QUIHelper::checkCenterRect(FormGeometry);
        //小分辨率重新调整
        if (QUIHelper::deskWidth() <= 1366) {
            FormMax = true;
            FormGeometry = deskRect;
        }

        //重新设置默认选择目录
        AppConfig::SelectDirName = QUIHelper::appPath() + "/db";
        writeConfig();
        return;
    }

    //加密过的密码在这里解密
    NvrUserPwd = QUIHelper::getXorEncryptDecrypt(NvrUserPwd, 100);
    SearchUserPwd = QUIHelper::getXorEncryptDecrypt(SearchUserPwd, 100);
...
void AppConfig::writeConfig()
{
    ...
    set.beginGroup("NvrConfig");
    set.setValue("NvrCopyrightName", NvrCopyrightName);
    set.setValue("NvrVideoType", NvrVideoType);
    set.setValue("NvrUserName", NvrUserName);
    set.setValue("NvrUserPwd", QUIHelper::getXorEncryptDecrypt(NvrUserPwd, 100));
    set.setValue("NvrVideoIP", NvrVideoIP);
    set.endGroup();

    set.beginGroup("SearchConfig");
    set.setValue("SearchUserName", SearchUserName);
    set.setValue("SearchUserPwd", QUIHelper::getXorEncryptDecrypt(SearchUserPwd, 100));
